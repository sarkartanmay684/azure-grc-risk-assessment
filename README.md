...
**→ [Read the full assessment (38 pages, PDF)](docs/Cloud-Security-Risk-Assessment-GRC-Simulation-Azure.pdf)** — the complete walkthrough, evidence, risk register, control mapping and report in a single document. Everything below is a summary of it.
